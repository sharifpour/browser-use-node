...
export declare const BrowserConfigSchema: z.ZodObject<
	...
	},
	{
		...
		cookiesFile?: string | undefined;
		minimumWaitPageLoadTime?: number | undefined;
		waitForNetworkIdlePageLoadTime?: number | undefined;
		maximumWaitPageLoadTime?: number | undefined;
	}
>;
			...
			z.ZodObject<
				{
					...
					minimumWaitPageLoadTime: z.ZodDefault<z.ZodOptional<z.ZodNumber>>;
					/** Time to wait for network idle in milliseconds */
					waitForNetworkIdlePageLoadTime: z.ZodDefault<
...
export declare const AgentRunParamsSchema: z.ZodObject<
	...
	},
	{
		...
		create_history_gif?: boolean | undefined;
	}
>;
